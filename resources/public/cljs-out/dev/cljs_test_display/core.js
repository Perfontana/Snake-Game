...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_17004);
...
var len__4736__auto___17008 = arguments.length;
var i__4737__auto___17009 = (0);
while(true){
if((i__4737__auto___17009 < len__4736__auto___17008)){
args__4742__auto__.push((arguments[i__4737__auto___17009]));

var G__17010 = (i__4737__auto___17009 + (1));
i__4737__auto___17009 = G__17010;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq17005){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17006,G__17007,seq17005__$2);
}));
...
var vec__17011 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__17011,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__17011,(1),null);
var G__17014 = cljs.core.PersistentArrayMap.EMPTY;
var G__17014__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__17014,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__17014);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__17014__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__17014__$1;
}
} else {
...
return (function() { 
var G__17018__delegate = function (klass,contents){
var vec__17015 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__17015,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__17015,(1),null);
...
var G__17018 = function (klass,var_args){
var contents = null;
...
while (G__17019__i < G__17019__a.length) {G__17019__a[G__17019__i] = arguments[G__17019__i + 1]; ++G__17019__i;}
  contents = new cljs.core.IndexedSeq(G__17019__a,0,null);
} 
return G__17018__delegate.call(this,klass,contents);};
G__17018.cljs$lang$maxFixedArity = 1;
G__17018.cljs$lang$applyTo = (function (arglist__17020){
var klass = cljs.core.first(arglist__17020);
var contents = cljs.core.rest(arglist__17020);
return G__17018__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__17024){
...
var ns = cljs.core.get.call(null,map__17025__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__17025__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__17027){
var map__17028 = p__17027;
var map__17028__$1 = (((((!((map__17028 == null))))?(((((map__17028.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__17028.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__17028):map__17028);
var actual = cljs.core.get.call(null,map__17028__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__17028__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__17030){
...
var expected = cljs.core.get.call(null,map__17031__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__17031__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__17033_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__17033_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__17035 = cljs_test_display.core.current_var_info.call(null);
...
var name = cljs.core.get.call(null,map__17035__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__17035__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__17035__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__17034_SHARP_){
return cljs.core.cons.call(null,node,p1__17034_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__17037){
...
var m = map__17038__$1;
var fail = cljs.core.get.call(null,map__17038__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__17038__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__17038__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__17038__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___17040 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___17040)){
var message_17041 = temp__5720__auto___17040;
cljs.core.println.call(null,message_17041);
} else {
}
...
var temp__5720__auto___17042 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___17042)){
var message_17043 = temp__5720__auto___17042;
cljs.core.println.call(null,message_17043);
} else {
}
