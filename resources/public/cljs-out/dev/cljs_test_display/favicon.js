...
return cljs.core.map.call(null,(function (p1__15440_SHARP_){
return html_coll.item(p1__15440_SHARP_);
...
return cljs.core.some.call(null,(function (p1__15441_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__15441_SHARP_);
...
var ctx_15442 = cvs.getContext("2d");
(ctx_15442.fillStyle = color);

ctx_15442.fillRect((0),(0),size,size);
