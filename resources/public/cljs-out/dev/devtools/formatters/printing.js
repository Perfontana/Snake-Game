...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq18450){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18451,G__18452,seq18450__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__18456_SHARP_){
return (!((cljs.core.meta.call(null,p1__18456_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__18457__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e18461){var _e__17435__auto__ = e18461;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e18463){var _e__17435__auto__ = e18463;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__18465 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__18466 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__18466);

try{var map__18467 = opts;
...
var markup_db = cljs.core.get.call(null,map__18467__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__18465);
}});
...
var temp__5718__auto___18472 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___18472)){
var managed_print_level_18473 = temp__5718__auto___18472;
var _STAR_print_level_STAR__orig_val__18470_18474 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__18471_18475 = managed_print_level_18473;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__18471_18475);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__18469_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__18469_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__18470_18474);
}} else {
job_fn.call(null);
}
