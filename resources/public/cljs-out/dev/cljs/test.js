...
var G__16914 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__16914,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__16914;
}
}));
...
var len__4736__auto___16919 = arguments.length;
var i__4737__auto___16920 = (0);
while(true){
if((i__4737__auto___16920 < len__4736__auto___16919)){
args__4742__auto__.push((arguments[i__4737__auto___16920]));

var G__16921 = (i__4737__auto___16920 + (1));
i__4737__auto___16920 = G__16921;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq16916){
var G__16917 = cljs.core.first.call(null,seq16916);
var seq16916__$1 = cljs.core.next.call(null,seq16916);
var G__16918 = cljs.core.first.call(null,seq16916__$1);
var seq16916__$2 = cljs.core.next.call(null,seq16916__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16917,G__16918,seq16916__$2);
}));
...
var file = cljs.core.get.call(null,map__16923__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__16923__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__16923__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__16922_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__16922_SHARP_));
...
var temp__5720__auto___16925 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___16925)){
var message_16926 = temp__5720__auto___16925;
cljs.core.println.call(null,message_16926);
} else {
}
...
var temp__5720__auto___16927 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___16927)){
var message_16928 = temp__5720__auto___16927;
cljs.core.println.call(null,message_16928);
} else {
}
...
var output_dir__$1 = (function (){var G__16929 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__16929,"/"].join('');
} else {
return G__16929;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__16931 = exception.stack;
var G__16931__$1 = (((G__16931 == null))?null:clojure.string.split_lines.call(null,G__16931));
var G__16931__$2 = (((G__16931__$1 == null))?null:cljs.core.get.call(null,G__16931__$1,depth));
if((G__16931__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__16931__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__16932 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__16932,(0),null);
var column = cljs.core.nth.call(null,vec__16932,(1),null);
var vec__16935 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__16935,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__16935,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__16935,(2),null);
...
var m__$1 = (function (){var G__16938 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__16942 = (function (){var G__16941 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__16941);
} else {
return G__16941;
}
})();
...
return cljs.core.vary_meta.call(null,G__16943,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__16947 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__16947,(0),null);
var types = vec__16947;
...
return cljs.core.map.call(null,(function (p__16950){
var vec__16951 = p__16950;
var ns = cljs.core.nth.call(null,vec__16951,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__16951,(1),null);
return (function (){
...
var G__16954 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__16955 = cljs.core.seq.call(null,vars__$1);
var chunk__16956 = null;
var count__16957 = (0);
var i__16958 = (0);
while(true){
if((i__16958 < count__16957)){
var v = cljs.core._nth.call(null,chunk__16956,i__16958);
var temp__5720__auto___16960 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___16960)){
var t_16961 = temp__5720__auto___16960;
each_fixture_fn.call(null,((function (seq__16955,chunk__16956,count__16957,i__16958,t_16961,temp__5720__auto___16960,v,each_fixture_fn,G__16954,G__16954__$1,env,once_fixtures,each_fixtures,vec__16951,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_16961)));
});})(seq__16955,chunk__16956,count__16957,i__16958,t_16961,temp__5720__auto___16960,v,each_fixture_fn,G__16954,G__16954__$1,env,once_fixtures,each_fixtures,vec__16951,ns,vars__$1))
);
} else {
}
...
var temp__5720__auto__ = cljs.core.seq.call(null,seq__16955);
if(temp__5720__auto__){
var seq__16955__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__16955__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__16955__$1);
var G__16966 = cljs.core.chunk_rest.call(null,seq__16955__$1);
var G__16967 = c__4556__auto__;
var G__16968 = cljs.core.count.call(null,c__4556__auto__);
var G__16969 = (0);
seq__16955 = G__16966;
...
var v = cljs.core.first.call(null,seq__16955__$1);
var temp__5720__auto___16970__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___16970__$1)){
var t_16971 = temp__5720__auto___16970__$1;
each_fixture_fn.call(null,((function (seq__16955,chunk__16956,count__16957,i__16958,t_16971,temp__5720__auto___16970__$1,v,seq__16955__$1,temp__5720__auto__,each_fixture_fn,G__16954,G__16954__$1,env,once_fixtures,each_fixtures,vec__16951,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_16971)));
});})(seq__16955,chunk__16956,count__16957,i__16958,t_16971,temp__5720__auto___16970__$1,v,seq__16955__$1,temp__5720__auto__,each_fixture_fn,G__16954,G__16954__$1,env,once_fixtures,each_fixtures,vec__16951,ns,vars__$1))
);
} else {
}


var G__16972 = cljs.core.next.call(null,seq__16955__$1);
var G__16973 = null;
var G__16974 = (0);
var G__16975 = (0);
seq__16955 = G__16972;
chunk__16956 = G__16973;
count__16957 = G__16974;
i__16958 = G__16975;
continue;
}
} else {
